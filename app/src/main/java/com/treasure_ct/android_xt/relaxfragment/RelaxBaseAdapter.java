...
public class RelaxBaseAdapter extends BaseAdapter implements MediaPlayer.OnPreparedListener, MediaPlayer.OnCompletionListener {
    private Context context;
    private List<RelaxModel> list;
    private static MediaPlayer mPlayer;
    private static int isPlayingPosition;

    public RelaxBaseAdapter(Context context, List<RelaxModel> list) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        RelaxModel model = list.get(position);
    ...
    public static class ViewHolder implements View.OnClickListener, SurfaceHolder.Callback {
        ...
        public void setModel(RelaxModel model) {
            mModel = model;
        }
