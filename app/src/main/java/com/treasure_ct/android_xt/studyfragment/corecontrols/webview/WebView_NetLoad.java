 ...
 */
public class WebView_NetLoad extends AppCompatActivity implements View.OnClickListener, BrowerSupport {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_corecontrols_webview_netload);
        Button gomove = (Button) findViewById(R.id.gomove);
        Button gostop = (Button) findViewById(R.id.gostop);
        Button goreload = (Button) findViewById(R.id.goreload);
        webView = (WebView) findViewById(R.id.webViewdemo1);
