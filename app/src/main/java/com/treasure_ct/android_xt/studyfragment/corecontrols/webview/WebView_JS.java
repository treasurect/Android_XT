 ...
 */
public class WebView_JS extends AppCompatActivity implements View.OnClickListener, BrowerSupport {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_corecontrols_webview_jsdemo);
        Button gomove = (Button) findViewById(R.id.gomove3);
        Button gostop = (Button) findViewById(R.id.gostop3);
        Button goreload = (Button) findViewById(R.id.goreload3);
        webView = (WebView) findViewById(R.id.webView_js);
        mProgressBar = (ProgressBar) findViewById(R.id.webView_progress_bar3);
